...
var defaultSysVars = []*SysVar{
	...
	{Scope: vardef.ScopeGlobal | vardef.ScopeSession, Name: vardef.TiDBOptGreedyJoinBestPair, Value: BoolToOnOff(vardef.DefTiDBOptGreedyJoinBestPair), Type: vardef.TypeBool, SetSession: func(s *SessionVars, val string) error {
		s.TiDBOptGreedyJoinBestPair = TiDBOptOn(val)
		return nil
	}},
